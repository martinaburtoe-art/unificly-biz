...
import { a as useBizUpdate, i as useBizList, n as useBizDelete, r as useBizInsert, t as fmtCLP } from "./biz-data-2nv6AG7B.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/quotes-0S1II_pd.js
...
function Quotes() {
	...
	async function downloadPdf(quote) {
		const { generateQuotePdf } = await import("./quote-pdf-n-LFixco.mjs");
